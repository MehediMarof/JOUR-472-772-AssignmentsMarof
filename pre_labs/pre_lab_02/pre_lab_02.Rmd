...
```{r}
and_theatre_seats_15 <- umd_courses |> filter(department == "Theatre" | seats >= 150)
...
1.  How much did each committee spend on social media advertising in 2021?

2.  How many courses explicitly mention themes like “social media,” “digital,” or “online” in their titles or descriptions, and in which departments?

3.  What share of campaign money flows to Maryland-based businesses compared to out-of-state companies? Which committees spend the biggest share out of state?
