...
**Answer:** The state with the largest percentage growth in population from 2000 to 2010 was Nevada, with an increase of approximately 35.1%.
...
**Answer:** The Maryland county with the highest median household income in 2021 was Howard County, with a median income of \$129,549 (± \$2,980 margin of error).
...
**Answer:** Median Household Income and Margins of Error by Maryland County (2017–2021 ACS)
...
**Answer:** The difference is not significant, because their error bars overlap almost entirely. Their true median incomes could plausibly be the same.

Is the difference between Howard and everyone else significant?

**Answer:** The difference is statistically significant — Howard’s error bar does not overlap with any other county, including Montgomery and Calvert. It clearly stands alone at the top.
...
**Answer:** Baltimore City, Allegany, Calvert, Frederick, and Anne Arundel saw the largest increases. No counties saw their median incomes fall from 2010 to 2021.
...
**Answer:** High schools with 60% or more graduates enrolling in college had an average household income of about \$69,252, based on 76 schools.
...
**Answer:** Do high schools located in areas with higher median household incomes tend to have higher immediate college enrollment rates among graduates?
